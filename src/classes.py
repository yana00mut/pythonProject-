...
class BaseProduct(ABC):
    ...
    @abstractmethod
    def price(self):
        """Геттер для получения цены (абстрактный)"""
        pass

    @price.setter
    @abstractmethod
    def price(self, new_price):
        """Сеттер с проверкой: цена не может быть 0 или меньше (абстрактный)"""
        pass

    @classmethod
    @abstractmethod
    def new_product(cls, data):
        """Класс-метод для создания продукта из словаря (абстрактный)."""
        pass

    @abstractmethod
    def __str__(self):
        """Строковое отображение продукта (абстрактный)"""
        pass

    @abstractmethod
    def add(self, other):
        """Складываем два товара по полной стоимости (абстрактный)"""
        pass
...
class Category:
    ...
    def __init__(self, name, description, products):
        self.name = name
        self.description = description
        self.__products = products  # Используем __products для инкапсуляции
